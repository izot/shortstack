...
typedef LON_STRUCT_BEGIN(SNVT_time_stamp) {
    LonWord year;
    LonByte month;
    LonByte day;
    LonByte hour;
    LonByte minute;
    LonByte second;
} LON_STRUCT_END(SNVT_time_stamp);

typedef LonWord SNVT_time_sec;

typedef SNVT_time_sec SCPTupdateRate;
...
#define SFPTrealTimeKeeper(mod)   SFPTrealTimeKeeper_##mod
typedef struct {
   unsigned global_index;
   struct {
      SNVT_time_stamp data;
      unsigned global_index;
      SCPTupdateRate* nciUpdateRate;
   } nvoTimeDate;
} SFPTrealTimeKeeper_rtc;

extern SFPTrealTimeKeeper_rtc rtc;

#define SFPTopenLoopActuator(mod, xxx)   SFPTopenLoopActuator_##mod##xxx
typedef struct {
   unsigned global_index;
   struct {
      SNVT_time_stamp data;
...
} SFPTopenLoopActuator_displaySNVT_time_stamp;

extern SFPTopenLoopActuator_displaySNVT_time_stamp display;
...
#define LON_APP_SIGNATURE 0xE9B5DE0D
#define LON_APPLICATION_MESSAGES 0
#define LON_SERVICE_PIN_TIMER 0
#define LON_PROGRAM_ID "9F:FF:FF:08:00:04:04:00"
