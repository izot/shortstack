...
static void blocks_init(void) {
   ...
   regularCO2.nvoCO2ppm.nciCO2MinDelta = &regularCO2__nvoCO2ppm__nciCO2MinDelta;
   {
      ...
      memcpy(&regularCO2__nvoCO2ppm__nciCO2MinDelta, init, sizeof(init));
   }
   regularCO2.nciMaxSendTime = &regularCO2__nciMaxSendTime;
   {
      const LonByte init[] = {11, 184};
      memcpy(&regularCO2__nciMaxSendTime, init, sizeof(init));
   }
   regularCO2.nciMinSendTime = &regularCO2__nciMinSendTime;
   {
      const LonByte init[] = {0, 50};
      memcpy(&regularCO2__nciMinSendTime, init, sizeof(init));
   }
}   // blocks_init
...
static const LonByte siData[] =
{
   ...
   0x2C, 0x35, 0x32, 0x00, 0xFF, 0x00, 0x7F
};
...
void* regularLonGetFile(int fileIndex, unsigned* pSize) {
    void* result = NULL;
    return result;
}
